// Generated on 2014-04-23 using generator-webapp 0.4.9
'use strict';
...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        useminPrepare: {
            ...
            html: '.tmp/index.html',
            css: ['.tmp/style.css','bower_components/bootstrap/dist/css/bootstrap.css']
        },
        ...
        cssmin: {
            dist: {
                files: {
                    '<%= config.dist %>/styles/style.min.css': ['.tmp/styles/*.css']
                }
            }
        },
